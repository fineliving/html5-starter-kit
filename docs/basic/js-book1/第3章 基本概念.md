...
- 特殊的字符字面量——转义序列
  ...
  - 用于表示非打印字符，或者具有其他用途的字符。
    ...
    ![non-printable](/basic/js-book1/non-printable.png)
...
<img src="/basic/js-book1/bitwise-positive.png" alt="bitwise-positive" style="zoom:75%;" />

计算-18 的二进制补码：
<img src="/basic/js-book1/bitwise-negative.png" alt="bitwise-negative" style="zoom:75%;" />
...
| --------------- | ---- | ------------------------------------------------------------------------------------------------ |
| 按位非（NOT）   | ~    | 返回**数值的反码**                                                                               |
| 按位与（AND）   | \&   | ![bitwise-and](/basic/js-book1/bitwise-and.png)                                                  |
| 按位或（OR）    | \|   | ![bitwise-or](/basic/js-book1/bitwise-or.png)                                                    |
| 按位异或（XOR） | ^    | ![bitwise-xor](/basic/js-book1/bitwise-xor.png)                                                  |
| 左移            | <<   | 将数值的所有位向左移动指定的位数                                                                 |
...
<img src="/basic/js-book1/bitwise-or-demo.png" alt="bitwise-or-demo"  />
...
25 与 3 按位异或的结果是 26：
![bitwise-xor-demo](/basic/js-book1/bitwise-xor-demo.png)
...
![bitwise-left](/basic/js-book1/bitwise-left.png)
...
![bitwise-right](/basic/js-book1/bitwise-right.png)
...
| ------ | ---- | ----------------------------------------------- |
| 逻辑非 | ！   | 转换为一个布尔值，再求反                        |
| 逻辑与 | &&   | ![boolean-and](/basic/js-book1/boolean-and.png) |
| 逻辑或 | \|\| | ![bitwise-or](/basic/js-book1/bitwise-or.png)   |
...
- 下表列出了一些特殊情况及比较结果：
  ...
  ![equality_operator](/basic/js-book1/equality_operator.png)
